...
require_once("./lib/config_paytmnew.php");
...
try {
	$sql = "UPDATE `onlinepu` SET `txtdate`='$PAY_TXNDATE',`paymentmode`='$PAY_PAYMENTMODE',`txnid`='$PAY_TXNID',`status`='$PAY_STATUS',`bankname`='$PAY_BANKNAME' WHERE application_no='$PAY_ORDERID'";
...
?>
<a href="<?php echo '/print_rece.php?application_no='.$PAY_ORDERID ?>"><button>
